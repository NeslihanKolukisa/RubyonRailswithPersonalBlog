...
class KategorisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kategori" do
    assert_difference('Kategori.count') do
      post kategoris_url, params: { kategori: { aciklama: @kategori.aciklama, ad: @kategori.ad } }
    end
  ...
  test "should update kategori" do
    patch kategori_url(@kategori), params: { kategori: { aciklama: @kategori.aciklama, ad: @kategori.ad } }
